...
ans = foreach(
                .inorder=FALSE,
                .combine=combine,
                .packages=c("pdq","scidb")
    ) %dopar% {
      doAtWorker(TRADE_DATE, TICKER_GROUP)
    }
```

... or any other Parallel programming construct

## Code package

> Trend for new technological adoption

Package containing:

- Common core functions
- Algorithms / Custom calculations
- Workflows
